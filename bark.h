...
extern "C" {
    ...
    struct bark_statistics {
        ...
        int64_t t_semantic_us = 0;
        int64_t t_coarse_us   = 0;
        int64_t t_fine_us     = 0;

        int32_t n_sample_semantic = 0;
        int32_t n_sample_coarse   = 0;
        int32_t n_sample_fine     = 0;
    };
    ...
    /**
     * Retrieves the statistics of the last audio generation round.
     *
     * @param bctx The Bark context to use for generating the audio.
     * @return A struct containing the statistics of the last audio generation round.
     */
    const bark_statistics * bark_get_statistics(
        struct bark_context *bctx);
